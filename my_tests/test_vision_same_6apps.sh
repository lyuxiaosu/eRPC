...
dispatcher_policy=$1
json_file="vision_apps_same_6apps.json"
#json_file="vision_apps_more_shorters.json"
...
if [ "$dispatcher_policy" == "DARC" ]; then
	...
	#more shorters
        #throughput_percentage=(10 20 30 40 50 60 65 70 75 80 84 86 88 90 94 96 98 100 101 102)
	#same
...
base_throughput3=2200
base_throughput4=2200
base_throughput5=2200
...
folder_name=$dispatcher_policy"-$flag-$suffix"
